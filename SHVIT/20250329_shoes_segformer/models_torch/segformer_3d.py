...
class SegFormer3D(nn.Module):
    ...
    """    
    def __init__(self, model_type: str="B0", shvit_type: str="", input_shape: tuple=(3,224,224,224), num_stages: int=3, num_classes: int=7, use_resize: bool=True):
        super(SegFormer3D, self).__init__()
        # 'shvit_type' and 'num_stages' are included for compatibility with class SegFormer3D_SHViT,
...
class SegFormer3D_SHViT(nn.Module):   
    ...
    def __init__(self, model_type: str="B0", shvit_type: str="S4", input_shape: tuple=(3,224,224,224),
                 num_stages: int=3, num_classes: int=7, use_resize: bool=True):
