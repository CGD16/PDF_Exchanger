...
class SegFormer(nn.Module):
    ...
    """    
    def __init__(self, model_type: str="B0", shvit_type: str="", input_shape: tuple=(3,224,224), num_stages: int=3, num_classes: int=7, use_resize: bool=True):
        super(SegFormer, self).__init__()
        # 'shvit_type' and 'num_stages' are included for compatibility with class SegFormer_SHViT,
